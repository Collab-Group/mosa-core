...
namespace Mosa.External.x86.Driver.Audio
{
    enum Options
    {
        ...
        MasterVolume = 0x22,
        SetIRQ = 0x80,
        StopPlayingEightBitChannel = 0xD0,
        ResumePlaybackOfEightBitChannel = 0xD4,
        StopPlayingSixteenBitChannel = 0xD5,
        ResumePlaybackOfSixteenBitChannel = 0xD6
    }
    ...
    enum DSP
    {
        ...
        Write = 0x22C,
        ReadStatus = 0x22E,
        SixteenBitInterruptAcknowledge = 0x22F,
        GetDSPVersion = 0xE1
    }
