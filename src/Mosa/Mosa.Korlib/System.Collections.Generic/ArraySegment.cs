...
namespace System.Collections.Generic
{
    ...
    public struct ArraySegment<T> : IList<T>, IReadOnlyList<T>
    {
        ...
        int IList<T>.IndexOf(T item)
        {
            ...
            /*int index = Array.IndexOf<T>(_array, item, _offset, _count);
        ...
        private sealed class ArraySegmentEnumerator : IEnumerator<T>
        {
            ...
            {
                Contract.Requires(arraySegment.MainArray != null);
                Contract.Requires(arraySegment.Offset >= 0);
                Contract.Requires(arraySegment.Count >= 0);
                Contract.Requires(arraySegment.Offset + arraySegment.Count <= arraySegment.MainArray.Length);
            ...
            public T Current
            {
                get
                {
                    if (_current < _start) throw new InvalidOperationException("Enum not started");
                    if (_current >= _end) throw new InvalidOperationException("Enum ended");
